...
Module.register("MMM-PiCameraStream", {
    ...
    defaults: {
        ...
        captureTimeoutMs: 4000 // NEW: max time to wait for rpicam-jpeg in local mode
    },
    ...
    start () {
        ...
        // Ensure local capture timeout is numeric and sane (min 2000ms, default 4000ms)
        this.config.captureTimeoutMs = Math.max(2000, Number(this.config.captureTimeoutMs) || 4000);
        this.imageSrc = null;
        this.status = "INIT";
        this.lastPing = 0;
        this.imgEl = null;
